...
from .base_tools import ProgressManager,FakeProgressManager,FakePool,get_kv_pairs
import trio
import queue
import inspect
import uuid
...
class TaskStateMachine():
    ...
    def __init__(
        ...
        Parameters:
            ...
            progress (Optional[ProgressManager], optional): An optional progress manager for tracking task execution progress. Defaults to None.
    ...
    @property
    def Progress(self) -> Optional[ProgressManager]:
    ...
    async def start_multiple_machines_coroutine(
        ...
        Parameters:
            ...
            progress (Union[ProgressManager, bool], optional): A progress manager for tracking execution or a boolean to enable/disable progress. Defaults to True.
...
class TaskWrapper(dict):
    ...
    @Progress.setter
    def Progress(self, value: Optional[ProgressManager]):
        self['progress'] = value
...
class TaskStateMachinePool():
    ...
    **Key Attributes:**
    ...
    - **progress (Union[ProgressManager, bool])**: Manages the progress of task execution, allowing for 
    ...
    **Methods:**
    ...
    def __init__(
        ...
        if progress is True:
            ...
            self.progress = FakeProgressManager()
        else:
            self.progress = progress
    ...
    @property
    def Progress(self) -> Union[ProgressManager,FakeProgressManager]:
        return self.progress
